...
public class ContainerFabricator extends ContainerLiquidTanks {
	...
	public ContainerFabricator(InventoryPlayer player, TileMachine tile) {
		super(tile, tile);
		this.tile = tile;
		...
		// Result
		this.addSlot(new SlotCrafter((ICrafter) tile.getMachine(), MachineFabricator.SLOT_RESULT, 139, 53));
