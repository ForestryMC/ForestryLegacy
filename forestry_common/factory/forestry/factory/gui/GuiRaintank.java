...
public class GuiRaintank extends GuiForestry {
	...
	public GuiRaintank(InventoryPlayer inventory, TileMachine tile) {
		super(Defaults.TEXTURE_PATH_GUI + "/raintank.png", new ContainerRaintank(inventory, tile), tile);
		slotManager.add(new LiquidTankSlot(this.slotManager, 53, 17, tile, 0));
	}
	...
	protected void drawGuiContainerBackgroundLayer(float var1, int i, int j) {
		...
		drawBackground();
		MachineRaintank machine = (MachineRaintank) tile.getMachine();
