...
public class StructureConstruction {
	...
	public int getCurrentX() {
		...
		/*
		 * switch(facing) { case WEST: return xPosition+xCurrent+xShift; case SOUTH: return xPosition-xCurrent-xShift; default: case EAST: return
		 * xPosition+xCurrent+zShift; }
		 */
	}
	...
	public int getCurrentZ() {
		...
		/*
		 * switch(facing) { case WEST: return zPosition-zCurrent-zShift; case SOUTH: return zPosition-zCurrent-zShift; default: case EAST: return
		 * zPosition+zCurrent+zShift; }
		 */
	}
