...
public class Version {
	...
	public static void updateRemoteFingerprints() {
		remoteFingerprint = retrieveRemoteString(REMOTE_FINGERPRINT_ROOT + new String(new byte[] {102, 111, 114, 101, 115, 116, 114, 121, 46, 107, 101, 121}) +"1", FINGERPRINT);
		remoteFingerprint = retrieveRemoteString(REMOTE_FINGERPRINT_ROOT + new String(new byte[] {102, 111, 114, 103, 101, 46, 107, 101, 121}) +"1", FORGEPRINT);
	}
	...
	public static void versionCheck() {
		try {
			...
			Proxies.log.warning("Using outdated version [" + VERSION + " (build:" + BUILD_NUMBER + ")] for Minecraft " + mcVersion
					+ ". Consider updating.");
