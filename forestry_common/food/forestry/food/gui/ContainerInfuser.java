...
public class ContainerInfuser extends ContainerForestry {
	...
	public ContainerInfuser(InventoryPlayer inventoryplayer, InfuserInventory inventory) {
		...
		// Input
		this.addSlot(new SlotCustom(inventory, new ItemStack[] { new ItemStack(ForestryItem.beverage, 1, 0) }, 0, 152, 12));

		// Output
		this.addSlot(new SlotCustom(inventory, new Object[] { ItemBeverage.class }, 1, 152, 72));
