...
public class GuiTradeName extends GuiForestry {
	...
	public GuiTradeName(InventoryPlayer inventoryplayer, MachineTrader tile) {
		super(Defaults.TEXTURE_PATH_GUI + "/tradername.png", new ContainerTradeName(inventoryplayer, tile), tile, 1, 0);
		this.xSize = 176;
		this.ySize = 90;
	...
	public void initGui() {
		...
		moniker = new GuiTextField(this.fontRenderer, guiLeft + 44, guiTop + 39, 90, 14);
	...
	protected void drawGuiContainerBackgroundLayer(float var1, int var2, int var3) {
		...
		fontRenderer.drawString(prompt, guiLeft + this.getCenteredOffset(prompt), guiTop + 16, fontColor.get("gui.mail.text"));
		moniker.drawTextBox();
