...
public class PluginFarmCraftory extends NativePlugin {
	...
	public static final String[] seedIdentifiers = new String[] {
	    "turnipSeedBag",
	    "cabbageSeedBag",
	    "onionSeedBag",
	    "spinachSeedBag",
	...
	public static final String[] vegetableIdentifiers = new String[] {
	    "turnipItem",
	    "cabbageItem",
	    "onionItem",
	    "spinachItem",
	...
	public static final String[] cseedIdentifiers = new String[] {
	    "cornSeedBag"
	};
	public static HashMap<String, ItemStack> cerealItems = new HashMap<String, ItemStack>();
	public static final String[] cerealIdentifiers = new String[] {
	    "cornItem"
	};
	...
	@Override public ISaveEventHandler getSaveEventHandler() { return null; }
