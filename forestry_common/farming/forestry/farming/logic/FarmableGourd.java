...
public class FarmableGourd implements IFarmable {
	...
	public boolean isSaplingAt(World world, int x, int y, int z) {
		...
		if(world.getBlockId(x, y, z) != stem.itemID)
			return false;
	...
	public ICrop getCropAt(World world, int x, int y, int z) {
		...
		if(world.getBlockId(x, y, z) != fruit.itemID)
			return null;
		
		if(world.getBlockMetadata(x, y, z) != fruit.getItemDamage())
			return null;
		
		return new CropBlock(world, fruit.itemID, fruit.getItemDamage(), new Vect(x, y, z));
	}
	...
	public boolean plantSaplingAt(ItemStack germling, World world, int x, int y, int z) {
		return world.setBlockWithNotify(x, y, z, stem.itemID);
	}
