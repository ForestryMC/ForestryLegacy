...
public class ContainerAlveary extends ContainerForestry {
	...
	public ContainerAlveary(InventoryPlayer player, TileAlvearyPlain tile) {
		...
		// Queen/Princess
		this.addSlot(new SlotCustom(tile, new Object[] { ForestryItem.beePrincessGE, ForestryItem.beeQueenGE }, TileAlvearyPlain.SLOT_QUEEN, 29, 39));

		// Drone
		this.addSlot(new SlotCustom(tile, new Object[] { ForestryItem.beeDroneGE }, TileAlvearyPlain.SLOT_DRONE, 29, 65));
