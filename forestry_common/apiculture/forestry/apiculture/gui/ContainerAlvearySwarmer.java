...
public class ContainerAlvearySwarmer extends ContainerForestry {
	...
	public ContainerAlvearySwarmer(InventoryPlayer player, TileAlvearySwarmer tile) {
		...
		this.addSlot(new SlotCustom(tile, getInducerItems(), 0, 79, 52));
		this.addSlot(new SlotCustom(tile, getInducerItems(), 1, 100, 39));
		this.addSlot(new SlotCustom(tile, getInducerItems(), 2, 58, 39));
		this.addSlot(new SlotCustom(tile, getInducerItems(), 3, 79, 26));
