...
public class ItemBeealyzer extends ItemForestry implements IInventoriedItem {
	...
	public static class BeealyzerInventory extends ItemInventory implements IErrorSource, IHintSource {
		...
		private void tryAnalyze() {
			...
			IBee bee = BeeManager.beeInterface.getBee(getStackInSlot(SLOT_SPECIMEN));
			// No bee, abort
			if (bee == null)
				return;
		...
		public EnumErrorCode getErrorState() {
			if (BeeManager.beeInterface.isBee(inventoryStacks[SLOT_SPECIMEN]) && !isEnergy(getStackInSlot(SLOT_ENERGY)))
