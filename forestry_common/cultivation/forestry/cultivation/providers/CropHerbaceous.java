...
public class CropHerbaceous implements ICropEntity {
	...
	public CropHerbaceous(World world, int i, int j, int k) {
		this.world = world;
		this.xCoord = i;
		this.yCoord = j;
		this.zCoord = k;
	...
	public ArrayList<ItemStack> doHarvest() {
		...
		if (blockid == Block.pumpkin.blockID) {
			harvest = Block.pumpkin.getBlockDropped(world, xCoord, yCoord, zCoord, 0, 0);
		} else if (blockid == Block.melon.blockID) {
			harvest = Block.melon.getBlockDropped(world, xCoord, yCoord, zCoord, 0, 0);
		}
