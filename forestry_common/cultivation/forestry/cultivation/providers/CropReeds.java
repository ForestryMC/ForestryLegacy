...
public class CropReeds implements ICropEntity {
	...
	public CropReeds(World world, int i, int j, int k) {
		this.world = world;
		this.xCoord = i;
		this.yCoord = j;
		this.zCoord = k;
	...
	public boolean isHarvestable() {
		...
		return blockMiddle == Block.reed.blockID && blockBottom == Block.reed.blockID;
	}
	...
	public ArrayList<ItemStack> doHarvest() {
		ArrayList<ItemStack> harvest = Block.reed.getBlockDropped(world, xCoord, yCoord, zCoord, 0, 0);
		Proxies.common.addBlockDestroyEffects(world, xCoord, yCoord, zCoord, Block.reed.blockID, 0);
