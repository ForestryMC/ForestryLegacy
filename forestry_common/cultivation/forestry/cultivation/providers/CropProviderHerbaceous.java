...
public class CropProviderHerbaceous implements ICropProvider {
	...
	public boolean isGermling(ItemStack germling) {
		return germling.itemID == Item.melonSeeds.itemID || germling.itemID == Item.pumpkinSeeds.itemID;
	}

	@Override
	public boolean isCrop(World world, int x, int y, int z) {
		int blockid = world.getBlockId(x, y, z);
		return blockid == Block.pumpkin.blockID || blockid == Block.melon.blockID;
	}
	...
	public ICropEntity getCrop(World world, int x, int y, int z) {
		return new CropHerbaceous(world, x, y, z);
	}
