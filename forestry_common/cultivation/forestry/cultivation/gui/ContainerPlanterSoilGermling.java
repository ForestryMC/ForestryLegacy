...
public class ContainerPlanterSoilGermling extends ContainerForestry {

	private TilePlanter planter;

	public ContainerPlanterSoilGermling(InventoryPlayer player, TilePlanter planter) {
		super(planter);
		...
		this.addSlot(new Slot(planter, 4, 107, 35));
		this.addSlot(new Slot(planter, 5, 107, 53));
		this.addSlot(new Slot(planter, 6, 125, 35));
		this.addSlot(new Slot(planter, 7, 125, 53));
