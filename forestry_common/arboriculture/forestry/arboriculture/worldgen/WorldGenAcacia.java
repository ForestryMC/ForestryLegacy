...
public class WorldGenAcacia extends WorldGenTree {
	...
	public void generate() {
		...
		if(rand.nextBoolean())
			generateCylinder(new Vector(0, leafSpawn--, 0), 4.9f, 1, leaf, false);
		else
			generateCylinder(new Vector(0, leafSpawn--, 0), 3.9f, 1, leaf, false);
	}
	...
	public BlockType getWood() {
		return new BlockType(ForestryBlock.log1.blockID, 2);
	}
