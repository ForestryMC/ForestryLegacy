...
public class PipeLogicPropolis extends PipeLogic {
	...
	public void setTypeFilter(ForgeDirection orientation, EnumFilterType type) {
		...
		if (!Proxies.common.isSimulating(container.worldObj)) {
	...
	public void requestFilterSet() {
		Proxies.net.sendToServer(new PacketCoordinates(PacketIds.PROP_REQUEST_FILTER_SET, container.xCoord, container.yCoord, container.zCoord));
	}
	...
	public void sendTypeFilterChange(ForgeDirection orientation, EnumFilterType filter) {
		...
		Proxies.net.sendToServer(new PacketUpdate(PacketIds.PROP_SEND_FILTER_CHANGE_TYPE, container.xCoord, container.yCoord, container.zCoord, payload));
	}
